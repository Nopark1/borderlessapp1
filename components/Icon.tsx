...
/** Discord brand glyph (filled, single path) — not a stroke icon. */
export function DiscordIcon({ size = 16, color = "#fff", style }: { size?: number; color?: string; style?: React.CSSProperties }) {
  return (

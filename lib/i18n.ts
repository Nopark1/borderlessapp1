...
const S: Dict = {
  ...
  articleOnceLive: { en: "Once published, this appears in the site Journal", jp: "公開すると、サイトのジャーナルに表示されます" },
  articleDraftHidden: { en: "Draft — hidden from the public Journal", jp: "下書き — 公開ジャーナルには表示されません" },
  articleLive: { en: "Live in the Journal", jp: "ジャーナルで公開中" },
  contentLang: { en: "Content language", jp: "記事の言語" },
  titleField: { en: "Title", jp: "タイトル" },
  excerptField: { en: "Excerpt", jp: "抜粋" },
  bodyField: { en: "Body", jp: "本文" },
  authorField: { en: "Author", jp: "執筆者" },
  roleField: { en: "Byline role (optional)", jp: "肩書き（任意）" },
  coverField: { en: "Cover image", jp: "カバー画像" },
  topicField: { en: "Topic", jp: "トピック" },
  readTimeField: { en: "Read time", jp: "読了時間" },
  attachmentsField: { en: "Attachments", jp: "添付ファイル" },
  ...
  statCompletion: { en: "Read completion", jp: "読了率" },
  statQuickExit: { en: "Quick exits", jp: "早期離脱" },
  statShares: { en: "Shares", jp: "シェア" },
  statDownloads: { en: "Downloads", jp: "DL" },
  statReadNext: { en: "Read next", jp: "次の記事" },
  statConversions: { en: "Event clicks", jp: "イベント誘導" },
  statViewsWeek: { en: "Views / 7d", jp: "閲覧/7日" },
  statLangSplit: { en: "Read in", jp: "閲覧言語" },
  statDevice: { en: "Device", jp: "デバイス" },
  statSources: { en: "Top sources", jp: "流入元" },
  statNewReturning: { en: "New vs returning", jp: "新規・リピート" },
  statNew: { en: "New", jp: "新規" },
  statReturning: { en: "Returning", jp: "リピート" },
  statByTopic: { en: "By topic", jp: "トピック別" },
  statMobile: { en: "Mobile", jp: "モバイル" },
  statDesktop: { en: "Desktop", jp: "デスクトップ" },
  blogOverview: { en: "Blog overview", jp: "ブログ概要" },
  ctaTitle: { en: "Come to an event", jp: "イベントに参加しよう" },
  ctaText: { en: "Borderless meets up across Kyoto every week — come as you are.", jp: "ボーダレスは毎週京都で開催中。気軽にご参加ください。" },
  publishArticle: { en: "Publish", jp: "公開する" },
  enVersion: { en: "English", jp: "英語版" },
  jpVersion: { en: "日本語", jp: "日本語版" },
  bothLangsHint: { en: "Write both language versions — readers see their own toggle.", jp: "両方の言語版を作成してください。読者は言語切り替えで表示します。" },
  articleTitle: { en: "Article", jp: "記事" },
  allArticles: { en: "All", jp: "すべて" },
  publishedTab: { en: "Published", jp: "公開中" },
  draftTab: { en: "Drafts", jp: "下書き" },
  untitledArticle: { en: "Untitled article", jp: "無題の記事" },
  previewLangHint: { en: "Preview shows", jp: "プレビュー表示" },
  noArticles: { en: "No articles yet. Click “New article” to write one.", jp: "記事がありません。「新規記事」で作成してください。" },
  deleteArticleQ: { en: "Delete this article?", jp: "この記事を削除しますか？" },
};
